...
- **В работе (служебная идентичность БД, уточнение 2026-09-15)**: согласованы
  ...
  и проверки перехода без записи; реализован фундамент. Хранение привязок состояний
  и заданий и транзакционная установка схемы проходят SQLite-тесты. Нативная проверка доступа
